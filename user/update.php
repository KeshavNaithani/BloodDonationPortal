<?php
   ...
   if (isset($_SESSION['user_id']) && !empty($_SESSION['user_id'])) {{
     $sql= "SELECT * FROM donor_details WHERE id=".$_SESSION['user_id'];
     ...
     //name check
        ...
        //gender check
             ...
             $donorDOB = $year."-".$month."-".$day;
              ...
              $sql = " UPDATE   donor_details SET name='$name',gender='$gender',email='$email',city='$city',dob='$donorDOB',contact_no='$contact_no',blood_group='$blood_group' WHERE id=".$_SESSION['user_id'];

                 if(mysqli_query($connection, $sql))
                 {
                   $dataupdate= '<div class="alert alert-success" role="alert">
...
Please Enter Valid Password
   ...
   if(isset($password)){
     $sql = "UPDATE donor_details SET password='$password' WHERE id= '$userID'";
     if(mysqli_query($connection,$sql )) {
       $passwordsuccess= '<div class="alert alert-success" role="alert">
...
<body>
    ...
    <div class="container py-4">
        ...
        <body class="text-center">
            ...
            <h1 class="display-4 fw-normal">Update Your Profile</h1>
...
<?php if(isset($showForm)) echo $showForm ;?>
    			...
    			<div class="row">
    				...
    				<div class=" card col-md-6 offset-md-3">
    					<div class="panel panel-default" style="padding: 20px;">
    						<form action="" method="post" class="form-group form-container padding: 20px 10px 20px 30px; " >
  ...
  <?php if (isset($blood_group)) echo '<option selected=""value"'.$blood_group.'">'.$blood_group.'</option>'; ?>
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" name="contact_no" value="" placeholder="<?php if(isset($contact_no)) echo $contact_no; ?>" class="form-control " required pattern="^\d{10}$" title="10 numeric characters only" maxlength="10" value="<?php if(isset($contact_no)) echo $contact_no; ?>" >
                      ...
                      <div class="form-group">
                          ...
                          <?php if (isset($cityError)) echo $cityError; ?>
    							...
    							<div class="form-group">
    								<button class="btn btn-lg btn-danger center-aligned" type="submit" name="submit">Update</button>
    							</div>
    						</form>
    					</div>
    				</div>
                ...
                <?php if (isset($dataupdate)) echo $dataupdate; ?>
